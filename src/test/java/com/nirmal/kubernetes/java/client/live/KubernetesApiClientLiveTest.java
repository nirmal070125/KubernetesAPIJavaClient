 ...
 *
 */
package com.nirmal.kubernetes.java.client.live;
...
import com.nirmal.kubernetes.java.client.KubernetesApiClient;
...
@Category(com.nirmal.kubernetes.java.client.LiveTests.class)
public class KubernetesApiClientLiveTest extends TestCase{
	...
	public void testPods() throws Exception { 
	    ...
	    PodList selectedPods = client.getSelectedPods(new Label[]{l});
    ...
    public void testReplicationControllers() throws Exception { 
        ...
        PodList podList = client.getSelectedPods(new Label[]{l1});
        assertNotNull(podList);
        assertNotNull(podList.getItems());
        assertEquals(replicas, podList.getItems().length);
        ...
        podList = client.getSelectedPods(new Label[]{l1});
        assertNotNull(podList);
        assertNotNull(podList.getItems());
        assertEquals(replicas, podList.getItems().length);
    ...
    public void testServices() throws Exception { 
        ...
        assertEquals(1, serviceList.getItems().length);
