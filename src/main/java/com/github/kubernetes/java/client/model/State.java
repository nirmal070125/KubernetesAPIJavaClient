...
public class State {
    ...
    private Map<String, StateInfo> info = new HashMap<String, StateInfo>();
    ...
    public String toString() {
        return "State [manifest=" + manifest + ", status=" + status + ", host=" + host + ", hostIP=" + hostIP
                + ", podIP=" + podIP + ", replicas=" + replicas + ", replicaSelector=" + replicaSelector
                + ", podTemplate=" + podTemplate + ", restartPolicy=" + restartPolicy + ", info=" + info + "]";
    }
